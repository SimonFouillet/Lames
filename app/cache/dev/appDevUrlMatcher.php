    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/blog')) {
            ...
            if (preg_match('#^/blog(?:/(?P<page>\\d*))?$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'testblog_accueil')), array (  '_controller' => 'Test\\BlogBundle\\Controller\\BlogController::indexAction',  'page' => '1',  'nbArticles' => 3,));
            }
            ...
            // testblog_tester
            if (0 === strpos($pathinfo, '/blog/tester') && preg_match('#^/blog/tester/(?P<text>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'testblog_tester')), array (  '_controller' => 'Test\\BlogBundle\\Controller\\BlogController::testAction',));
            }
